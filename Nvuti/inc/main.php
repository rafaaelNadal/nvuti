            ...
            <div class="container">
                ...
                <div class="navbar-innr">
                    ...
                    <ul class="navbar-menu mmmob">
                       ...
                       <li><a class="asff4" onclick="location.href='#listTickets'">Служба поддержки</a></li>
  ...
  margin: 0 16px;
    ...
    background-size: 100% 100%;
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dice-game">Main game</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#battle">Battle dice </a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tower"">Tower(скоро)</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#jackpot"">Jackpot(скоро)</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#x50"">x50(скоро)</a></li>
</ul>
<ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#mines"">Mines(скоро)</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#coinflip"">Coinflip(скоро)</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#triple"">Triple(скоро)</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#whell"">Whell(скоро)</a></li>
                        </ul>
        ...
        <div class="modal-content"><a class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body">
                ...
                <ul class="pay-list guttar-15px">
                    ...
                    <li class="pay-item" onclick="$('#systemPay').val('1')"><input type="radio" class="pay-check" name="pay-option" id="pay-paypal"><label class="pay-check-label" for="pay-paypal"><img src="../images/fk-logo.png" alt="pay-logo" style="height: 35px;margin: 10px;"></label></li>
                       <!--
...
</ul><label for="token-address" class="input-item-label">Для получения бонуса:</label>
<div class="input-item input-with-label"><input class="input-bordered col-6" type="text" id="depositSize" value="Промокод (если есть)"></div>
                ...
                <div class="gaps-2x"></div>
    <hr>
<center><h4>Не забудьте указать бонус-код!<a target="_blank" href="<?=$group?>"> Промокоды тут</a></h4></center>
<br>
				<div style="border: 1px solid #e6eff5">
					...
					<b style="display: block; text-align: center;">
						...
						<span style="color: #c91c46">150₽</span>
						 получи 
						<span style="color: #1c65c9">+10%</span> в подарок!
					</b>
				</label>
				</div>	
				...
				<div style="border: 1px solid #e6eff5">
					...
					<b style="display: block; text-align: center;">
						...
						<span style="color: #c91c46">500₽</span>
						 получи 
						<span style="color: #1c65c9">+15%</span> в подарок!
					</b>
				</label>
				</div>	
				...
				<div style="border: 1px solid #e6eff5">
					...
					<b style="display: block; text-align: center;">
						...
						<span style="color: #c91c46">1000₽</span>
						 получи 
						<span style="color: #1c65c9">+20%</span> в подарок!
					</b>
				</label>
				</div>		
				...
				<div style="border: 1px solid #e6eff5">
					...
					<b style="display: block; text-align: center;">
						...
						<span style="color: #c91c46">2000₽</span>
						 получи 
						<span style="color: #1c65c9">+25%</span> в подарок!
					</b>
				</label>
				</div>
<br>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-12">
                <ul class="footer-links">
					...
					<li><a href="https://vk.com/krasovko">Comlete by Krasovka</a></li>
                </ul>
            </div><!-- .col -->
            <!-- .col -->
        </div><!-- .row -->
