  ...
  margin: 0 16px;
    ...
    background-size: 100% 100%;
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tower" style="display:none">Tower</a></li>
                        </ul>
                    ...
                    <div class="card-innr">
                        ...
                        <div class="tab-content" id="profile-details">
                            ...
                            <div class="tab-pane fade" id="settings">
                                ...
                                <a href="http://1nvuti.space/login.php" class="btn btn-outline btn-dark btn-facebook " style="margin-top:10px"><em class="fab fa-vk"></em><span>Привязать аккаунт</span></a>
                ...
                <div class="form-step-head card-innr" style="border-top:0">
                    <div class="step-head">
                        ...
                        <div class="step-head-text">
                            <h4>Привяжите аккаунт Вконтакте</h4><a href="http://1nvuti.space/login.php" class="btn btn-outline btn-dark btn-facebook " style="margin-top:10px"><em class="fab fa-vk"></em><span>Привязать аккаунт</span></a>
